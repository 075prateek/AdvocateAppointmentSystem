...
public class AdvocateAppointmentApp 
{
    ...
    public static void modifyAppointment() throws SQLException ,AppointmentNotFoundException, AdvocateNotFoundException{
    ...
    AdvocateNotFoundException {
    	...
    	Appointment obj= new Appointment(customer_Obj.getCustomerId(),advocate_Obj.getAdvocateId(),appointment_Date);
